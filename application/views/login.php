...
<div class="form_wrap">
	<div class="form_container">
        ...
        <div class="form_inner">
            ...
            <form method="post" action="<?php echo base_url();?>login/login_user" id="LoginForm">
                <div class="form-group">
                    <input type="text" id="UserEmailLogin1" error-msg="Email/Username Cannot be Blank" name="email" class="form-control required_validation_for_login_management" placeholder="Email/Username Address">
                </div>
                <div class="form-group">
                    <input type="password" error-msg="Password Cannot be Blank" name="password" class="form-control required_validation_for_login_management" placeholder="Password">
                </div>
            ...
            <p><a href="<?php echo  base_url();?>login/register">Sign up for an account</a> | <a href="<?php echo base_url() ?>login/forgetpassword">Forgot Your Password?</a></p>
...
<script type="text/javascript">
   $(document).on('submit','#LoginForm',function(data){   
    var checkNumber;
...
$(document).ready(function() { 
    $("#UserEmailLogin").bind("blur", function () {
        $(".error").hide();
        var hasError = false;
        var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        var emailaddressVal = $("#UserEmailLogin").val();
        if(emailaddressVal == '') {
            hasError = true;  
        }
