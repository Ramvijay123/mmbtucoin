        ...
        <div class="form_inner">
            ...
            <form method="post" action="Security_login/login_user" id="twoFAForm">
                <div class="form-group">
                    <input type="text" id="UserEmailLogin" error-msg="Varification Code Cannot be Blank" name="code" class="form-control required_validation_for_login_management" placeholder="Varification Code">
            ...
            <p><a href="http://mmbtucoin.com/mmbtucoin/Security_login/forgotTwoFA">Forgot Your 2 factor Authentication?</a></p>
