...
<div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            $RemovalStdClass=get_object_vars($getabout[0]);
            ?>
            <div class="box-body table-responsive padding">
            <form method="post" action="<?php echo base_url();?>admin/About/aboutdata/<?php echo $RemovalStdClass['id'];?>" enctype="multipart/form-data">
            <div class="form-group row">
                    <label for="inptEmail3" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea type="text" class="form-control" name="description"><?php echo $RemovalStdClass['description'];?></textarea>
                </div>
            </div>
             <div class="form-group row">
