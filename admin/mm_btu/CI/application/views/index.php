  ...
  <nav id="navigation_bar" class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
      	<div class="logo"> <a href="index.html"><img src="<?php echo base_url();?>assests/images/logo.png" alt="image"/></a> </div>
...
<section id="aboutus" class="section-padding">
	<div class="container">
    	<div class="section-header">
        	<h2>Who We Are</h2>
            <p>A Digital marketplace for tokens</p>
        </div>
        <div class="row">
        	<div class="col-md-8">
            	<div class="coin_flow">
                	...
                	<img src="<?php echo base_url();?>assests/images/coin_flow.png" alt="image">
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="roadmap_flow">
        	<ul>
            	<li class="st_1 up_arrow">
                	<h6>June 2017 </h6>
                    <p>Development of the scoring model</p>
                </li>
	...
	<div class="container">
        ...
        <div class="row">
        	<div class="col-md-4 team_wp">
            	<div class="box_wrap">
                	<div class="team_img">
                    	<img src="<?php echo base_url();?>assests/images/team_img.jpg" alt="image">
                    </div>
                    <div class="team_info">
                    	<h6>Mason Liam</h6>
                        <p>(Co-Founder & CEO)</p>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                	<div class="panel panel-default">
                        <div class="panel-heading" role="tab">
                          ...
                          <a role="button" data-toggle="collapse" href="#collapse_1" aria-expanded="true" data-parent="#accordion">What is Token Sale? </a></h4>
                        </div>
	...
	<div class="container">
        ...
        <div class="row">
        	<div class="col-md-4">
            	<div class="blog_wrap">
                	<div class="post_img">
                    	<a href="#"><img src="<?php echo base_url();?>assests/images/post_img1.jpg" alt="image"></a>
                    </div>
                    <h3><a href="#">Benefits of getting Cryptocurrency Investment</a></h3>
                    <div class="post_meta">
                        <ul>
