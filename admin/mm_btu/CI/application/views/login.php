...
<div class="form_wrap">
	<div class="form_container">
        ...
        <div class="form_inner">
            ...
            <form method="post" action="login_user" id="LoginForm">
                <div class="form-group">
                    <input type="email" id="UserEmailLogin" error-msg="Email Cannot be Blank" name="email" class="form-control required_validation_for_login_management" placeholder="Email Address">
                </div>
                <div class="form-group">
